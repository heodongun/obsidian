---
title: "NASA는 C 코드를 이렇게 짠다고? - 소개, 가독성 및 유지보수성"
description: "NASA의 공식 C언어 가이드를 번역한 글입니다."
source: "https://velog.io/@pobi/NASA-C-STYLE-GUIDE-12"
source_slug: "NASA-C-STYLE-GUIDE-12"
author: "pobi"
author_display_name: "포비"
released_at: "2025-04-07T01:44:26.976Z"
updated_at: "2026-03-21T03:11:53.235Z"
thumbnail: "https://velog.velcdn.com/images/pobi/post/575f4733-4f18-4e48-a3f0-4672567573e6/image.png"
tags: []
---# 1. 소개 (INTRODUCTION)
...
- 박스형 주석 - 머리말이나 섹션 구분 기호로 사용하세요.
- 블록 주석 - 코드의 주요 섹션 시작 부분에 해당 부분에 대한 설명을 작성하세요.
- 짧은 주석 - 코드나 데이터 정의와 같은 줄에 작성하세요.
- 인라인 주석 - 코드가 있는 들여쓰기 수준과 동일하게 작성하세요.
<br>
예: 박스형 주석 머리말
```
/******************************************************************************
...
```
_ptr    포인터 (pointer)
_file   파일 타입의 변수 (variable of type file*)
_fd     파일 설명자 (file descriptor)
```
...
- 변수 : 소문자를 사용하고 단어 사이에 밑줄을 사용하세요.
- 함수 이름 : 각 단어의 첫 글자를 대문자로 쓰고 밑줄은 사용하지 마세요.
- 상수 : 모든 글자를 대문자로 쓰고 단어 사이에 밑줄을 사용하세요.
- C 바인딩 : 문자 "c" 다음에 밑줄과 바인딩 이름을 사용하세요.
...
- 타입 이름 (예: typedef로 생성된 타입): 전역 변수 명명 규칙을 따르세요.
- 열거형 타입 (enum으로 선언됨) 및 const를 사용하여 선언된 상수: 상수 명명 규칙을 따르세요.
